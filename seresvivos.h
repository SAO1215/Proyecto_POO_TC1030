 ...
 * A01707371
 *
 * Esta clase define objeto de tipo SeresVivos contiene las clases heredadas 
 * Flora y Fauna.
 *
 */
...
//Declaracion clase SeresVivos que es abstracta, es la clase madre de Flora y Fauna
class SeresVivos {
...
class Fauna: public SeresVivos{
    ...
    public:
        Fauna(): SeresVivos("", "", "") {};
        Fauna(string nom, string tip, string stat, string ali, string gest, 
         double cant, double super):SeresVivos(nom,tip,stat),
        alimentacion(ali),
        gestacion(gest),
        cantidad(cant),
        superficie(super) {};
...
void Fauna::resumen(){
  ...
  cout << "Alimentacion: "<< getAlimentacion() << endl;
  cout << "Gestacion: "<< getGestacion() << endl;
...
class Flora: public SeresVivos{
    ...
    public:
        Flora(): SeresVivos("", "", "") {};
        Flora(string nom, string tip, string stat, double plant, double sep, 
         double terr):SeresVivos(nom,tip,stat),
        plantacion(plant),
        separacion(sep),
        terreno(terr){};
